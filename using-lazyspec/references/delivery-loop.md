...
- Before implementing, confirm explicit approval of the current Requirements, Design, and Tasks under approval-policy.md. An execution request alone does not approve unseen plan changes.

...
|---|---|---|---|
| low | Local, readily reversible; no public interface, persistent data, or permission-boundary changes | Combined plan review under approval-policy.md | All acceptance outcomes and directly affected regression checks |
